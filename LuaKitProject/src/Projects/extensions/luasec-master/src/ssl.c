...
LSEC_API int luaopen_ssl(lua_State *L) {
  ...
  // lua_pushcfunction(L, meth_compression);
  // lua_setfield(L, -2, "compression");
  // lua_pushcfunction(L, meth_create);
  // lua_setfield(L, -2, "create");
  // lua_pushcfunction(L, meth_info);
  // lua_setfield(L, -2, "info");
  // lua_pushcfunction(L, meth_setfd);
  // lua_setfield(L, -2, "setfd");
  // lua_pushcfunction(L, meth_setmethod);
  // lua_setfield(L, -2, "setmethod");
  // lua_pushcfunction(L, meth_copyright);
  // lua_setfield(L, -2, "copyright");
  // lua_setfield(L, -2, "core");
  // // // traceback(L);
  // //
  // lua_pushvalue(L, -1);
  // // lua_setfield(L, LUA_GLOBALSINDEX, "ssl");
  // //
  // lua_setglobal(L, "ssl");
